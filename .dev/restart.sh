...
echo "\n\n\n\n------------------------------------\nRunning: cd /projects/hooman_frontend\n------------------------------------\n\n\n\n"
cd /projects/hooman_frontend

echo "\n\n\n\n------------------------------------\nRunnin: sudo pm2 delete "hooman_frontend"\n------------------------------------\n\n\n\n"
sudo pm2 delete "hooman_frontend"
...
echo "\n\n\n\n------------------------------------\nRunning: sudo pm2 start "npm start" --name "hooman_frontend"\n------------------------------------\n\n\n\n"
sudo pm2 start "npm start" --name "hooman_frontend"
